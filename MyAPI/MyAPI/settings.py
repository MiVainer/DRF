...
SECRET_KEY = "django-insecure--dj*j*p#ter%z0xosk$+@n=cyb$jpa00vi)srn#gugoj0)+ca#"
...
# Тут настраиваем глобальные права доступа, в views локальные
    ...
    'DEFAULT_AUTHENTICATION_CLASSES': [
        ...
        'rest_framework_simplejwt.authentication.JWTAuthentication', # По JWT токенам
    ]
}
